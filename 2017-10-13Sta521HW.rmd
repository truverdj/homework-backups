...
glmCoverage = function(model, newdata, nsim, newResponse){ # hold onto your butts; it's about to get empirical 
  ...
  intervalMatrix = matrix(NA, ncol = 2, nrow = dim(newdata)[1])
  for (i in 1:nsim){
